...
A dark and minimalistic theme for [OmniFocus](https://www.omnigroup.com/omnifocus).
...
Double click on `Niflheim.ofocus-style`.
...
The OmniFocus port was written by [Benjamin Van Ryseghem](http://benjamin.vanryseghem.com).
